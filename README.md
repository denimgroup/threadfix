**NOTE**: If you wish to download the latest build of ThreadFix please visit [builds](https://github.com/denimgroup/threadfix/wiki/ThreadFix-2.0MS2). **DO NOT** "Download ZIP".   
