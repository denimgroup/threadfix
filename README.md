**NOTE**: If you wish to download the latest build of ThreadFix please visit [the ThreadFix download page](http://www.threadfix.org/download/). Please **DO NOT** use the "Download ZIP" from GitHub.   
