		...
		<tbody>
			<tr>
				...
				<td class="pointer" id="tab-dashboard" style="width: 130px;">
					<a class="fill-div" id="dashboardHeader" href="<spring:url value="/dashboard" htmlEscape="true"/>">Dashboard</a>
				</td>
				<td class="pointer" id="tab-apps" style="width: 120px;">
					<a class="fill-div" id="orgHeader" href="<spring:url value="/teams" htmlEscape="true"/>">Teams</a>
				</td>
				<td class="pointer" id="tab-scans" style="width: 90px;">
					<a class="fill-div" id="scansHeader" href="<spring:url value="/scans" htmlEscape="true"/>">Scans</a>
				</td>
				<security:authorize ifAnyGranted="ROLE_CAN_GENERATE_REPORTS">
					<td class="pointer" id="tab-reports" style="width: 110px;">
						<a class="fill-div" id="reportsHeader" href="<spring:url value="/reports" htmlEscape="true"/>">Analytics</a>
					</td>
				</security:authorize>
