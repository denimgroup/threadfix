    ...
    <div class="filter-group-body" ng-show="showDateControls">
        <div class="accordion-inner">
            ...
            <ul class="nav nav-pills">
                <li id="lastYear" ng-class="{ active: parameters.daysOldModifier === 'LastYear' }"><a ng-click="setDaysOld('LastYear')">Last Year</a></li>
                <li id="lastQuarter" ng-class="{ active: parameters.daysOldModifier === 'LastQuarter' }"><a ng-click="setDaysOld('LastQuarter')">Last Quarter</a></li>
                <li id="forever" ng-class="{ active: parameters.daysOldModifier === 'Forever' }"><a ng-click="setDaysOld('Forever')">Forever</a></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="accordion-inner">
            <div class="col-md-6">
                ...
                <div ng-show="showFullControls">
                    <input id="defaultTrendingSel" type="checkbox" class="btn" ng-model="parameters.defaultTrending"/>Default Trending Filter<br>
                </div>
...
<div ng-show="showSavedFilters">
    ...
    <div class="saved-filters-tab" ng-show="savedFilters && savedFilters.length > 0">
        ...
        <select id="filterSelect" style="width: 220px;" ng-model="selectedFilter" ng-change="loadFilter(selectedFilter)"
