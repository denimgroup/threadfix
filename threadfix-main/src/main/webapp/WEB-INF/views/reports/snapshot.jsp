<div ng-controller="SnapshotReportController">
    ...
    <div class="vuln-tree">
        ...
        <div ng-show="snapshotActive" id="pointInTimeDiv">
            ...
            <d3-pointintime ng-show="pointInTimeData && reportId == PIT_Report_Id" data="pointInTimeData" label="title" export-report-id="exportReportId"></d3-pointintime>

            <!-- Vulnerability Progress By Type report -->
            <%@ include file="progressByVulnerability.jsp"%>
            <d3-hbars ng-show="topAppsData && reportId == MVA_Report_Id" data="topAppsData" label = "title" width="670" height="612" margin="margin" export-report-id="exportReportId"></d3-hbars>
        </div>
    </div>
