    ...
    <table ng-show="scans" class="table table-striped">
        <thead>
            <tr>
                ...
                <th style="width:180px" ng-show="scansToDownload"></th>
            </tr>
        </thead>
        <tbody>
            <tr ng-repeat="scan in scans" class="bodyRow">
                ...
                <c:if test="${ canUploadScans }">
                    <td id="delete{{ $index }}">
                        <a id="deleteScan{{ $index }}" ng-hide="scan.deleting" class="btn btn-danger" ng-click="deleteScan(scan)">Delete Scan</a>
                        <a id="scanDeleting{{ $index }}" ng-show="scan.deleting" class="btn btn-danger" ng-disabled>
