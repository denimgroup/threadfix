...
<table ng-show="teams" class="table table-hover white-inner-table"
    ...
    <tr ng-show="team.expanded && team.countApps > numAppsPerTeam"
        ...
        <td colspan="8">
            <div class="pagination" ng-init="team.page = 1" ng-show="team.countApps > numAppsPerTeam">
                <pagination id="appPagination{{team.id}}"
                            class="no-margin"
                            total-items="team.countApps / numAppsPerTeam * 10"
                            max-size="5"
                            page="team.page"
                            first-text="&laquo;"
                            last-text="&raquo;"
                            ...
                            ng-model="page"
                            ng-click="updatePage(team.page, team.goToApp, team)"></pagination>
            </div>
                        ...
                        <tr class="app-row" ng-repeat="app in team.applications | filter:active" ng-init="appIndex=$index"
                            ...
                            <td class="pointer" style="padding:5px;word-wrap: break-word;">
                                <div style="word-wrap: break-word;width:120px;text-align:left;">
                                    <a id="applicationLink{{ team.name }}-{{ app.name }}" ng-href="{{ app.pageUrl }}">{{ app.name }}</a>
                                </div>
                            </td>
