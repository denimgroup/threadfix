...
<div class="accordion-group"  ng-hide="reportId && reportId == OWASP_Report_Id">
    ...
    <div class="filter-group-body" ng-show="showDetailsControls">
        ...
        <div class="accordion-inner">
            ...
            <br>
            <div>
                <input type="checkbox" class="btn" ng-change="refresh()" ng-model="parameters.severities.critical" id="showCritical"/><span generic-severity="Critical"></span><br>
                ...
                <input type="checkbox" class="btn" ng-change="refresh()" ng-model="parameters.severities.info" id="showInfo"/><span generic-severity="Info"></span>
            </div>
        </div>
