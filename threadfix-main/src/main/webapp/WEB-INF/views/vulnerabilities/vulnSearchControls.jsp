<div ng-controller="VulnSearchController">
    ...
    <div class="vuln-search-filter-control">
        ...
        <div ng-repeat="filteredTeam in parameters.teams">
            <input typeahead="team.name for team in teams | filter:$viewValue | limitTo:8" type="text" ng-model="filteredTeam.name" name="team"/>
    ...
    <div class="vuln-search-filter-control">
        ...
        <div class="btn-group">
            ...
            <label class="btn" ng-model="parameters.severities.medium" btn-checkbox>Medium</label>
    ...
    <div class="vuln-search-filter-control">
        ...
        <div class="btn-group">
            <label class="btn" ng-click="refresh()" ng-model="parameters.numberVulnerabilities" btn-radio="10">10</label>
            <label class="btn" ng-click="refresh()" ng-model="parameters.numberVulnerabilities" btn-radio="25">25</label>
            <label class="btn" ng-click="refresh()" ng-model="parameters.numberVulnerabilities" btn-radio="50">50</label>
            <label class="btn" ng-click="refresh()" ng-model="parameters.numberVulnerabilities" btn-radio="100">100</label>
        </div>
    </div>
