...
public class AutoGeneratedParameterNameTests {
    ...
    public void testFullIntegration() {
        EndpointDatabase database = EndpointDatabaseFactory.getDatabase(TestConstants.WEB_FORMS_MODIFIED);

        assert database != null : "Database was null for " + TestConstants.WEB_FORMS_MODIFIED;
