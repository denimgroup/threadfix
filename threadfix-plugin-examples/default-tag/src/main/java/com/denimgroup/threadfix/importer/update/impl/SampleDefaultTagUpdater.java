...
/**
 * This class adds the default tag to the database so it is available to the other parts of ThreadFix.
 * We can leverage the existing method in DefaultTagUpdater to do all the actual work; having this file in
 * the JAR and supplying the path in getFolder() is enough for ThreadFix to update correctly.
 */
@MappingsUpdater
public class SampleDefaultTagUpdater extends DefaultTagUpdater {
