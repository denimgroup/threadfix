...
public class GroupUsersConfigController {
	
	public GroupUsersConfigController(){}
	
	private UserService userService = null;
	private AccessGroupService groupService = null;
	
	private final SanitizedLogger log = new SanitizedLogger(GroupUsersConfigController.class);

	@Autowired
	public GroupUsersConfigController(UserService userService,
	...
	public String processUsersForm(@PathVariable("groupId") int groupId, 
		...
		groupService.setUsersForGroup(groupId, groupModel.getObjectIds());
