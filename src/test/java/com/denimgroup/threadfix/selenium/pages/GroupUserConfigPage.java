...
public class GroupUserConfigPage extends BasePage {
	...
	public GroupUserConfigPage(WebDriver webdriver) {
		super(webdriver);
		...
		backToMenuLink = driver.findElementById("backToGroupsPage");
	...
	public GroupUserConfigPage toggleUserIdBox(int row) {
...
//		groupIdCheckBoxes.get(row).click();
	...
	public GroupUserConfigPage toggleUserIdBox(String userName, boolean on) {
	...
	public GroupsIndexPage clickBackToMenuLink() {
		backToMenuLink.click();
		return new GroupsIndexPage(driver);
	}
	
	public GroupsIndexPage clickSubmitButton() {
		submitButton.click();
		return new GroupsIndexPage(driver);
	}
